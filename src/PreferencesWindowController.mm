...
static PreferencesWindowController *preferencesWindowController = nil;
...
+ (PreferencesWindowController *)shared {
  if (!preferencesWindowController) {
    preferencesWindowController = [[PreferencesWindowController alloc] initWithLocalLibrary:[LocalLibrary shared]];
  }
